...
const Doc = ({setwindowStatus,windowStatus}) => {
  return (
    <footer>
        <div className="icon calender " onClick={()=>{setwindowStatus(windowStatus.Calender ? (status =>({ ...status, Calender: false })):((status =>({ ...status, Calender: true }))))}}><img src="../../public/all_svgs/calender.svg"></img></div>
        ...
        <div className="icon mail" onClick={()=>{window.open("https://mail.google.com/mail/u/0/#inbox?compose=sid@gmail.com", "_blank")}}><img src="../../public/all_svgs/mail.svg" alt="" /></div>
